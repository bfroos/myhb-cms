...
export interface ApiBlogArticleBlogArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    footnotes: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCareerPageCareerPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bottomBlocks: Schema.Attribute.DynamicZone<
      [
        'blocks.benefits-list',
        'blocks.comparison-block',
        'blocks.directions',
    ...
    jobTeasers: Schema.Attribute.Component<'career-page.job-teasers', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCityPageCityPage extends Struct.SingleTypeSchema {
...
export interface ApiCityCity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    federalState: Schema.Attribute.Enumeration<
      [
        'baden-wuerttemberg',
        'bavaria',
        'berlin',
...
export interface ApiDoctorsPageDoctorsPage extends Struct.SingleTypeSchema {
  collectionName: 'doctors_pages';
  info: {
    displayName: 'Doctors Page';
    pluralName: 'doctors-pages';
    singularName: 'doctors-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiEmployeeEmployee extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    employeeType: Schema.Attribute.Enumeration<['doctor', 'staff']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    hideFromPublic: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    publishedAt: Schema.Attribute.DateTime;
    qualificationGroups: Schema.Attribute.Component<
      'employee.qualification-group',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vitaEntries: Schema.Attribute.Component<'employee.vita-entry', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFaqSetFaqSet extends Struct.CollectionTypeSchema {
  collectionName: 'faq_sets';
  info: {
    displayName: 'FAQ Set';
    pluralName: 'faq-sets';
    singularName: 'faq-set';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faqSets: Schema.Attribute.Relation<'manyToMany', 'api::faq-set.faq-set'>;
    internalLabel: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiJobPageJobPage extends Struct.SingleTypeSchema {
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    applyTarget: Schema.Attribute.Enumeration<['url', 'email']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    genderHint: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'m/w/d'>;
    hourlyRateMaxInEuroCent: Schema.Attribute.Integer &
    ...
    hourlyRateMinInEuroCent: Schema.Attribute.Integer &
      Schema.Attribute.CustomField<'plugin::amount-cents.price'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    recruiter: Schema.Attribute.Relation<'oneToOne', 'api::employee.employee'>;
...
export interface ApiLandingPageLandingPage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Visual page builder landing pages';
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    about: Schema.Attribute.Component<'location.about', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    buildingImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    contact: Schema.Attribute.Component<'location.contact', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    directions: Schema.Attribute.Component<'blocks.directions', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    isBookingAllowed: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    newOpeningDate: Schema.Attribute.Date &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    openingHours: Schema.Attribute.Component<'shared.opening-hours', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    type: Schema.Attribute.Enumeration<['lounge', 'center', 'clinic']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
      ...
      Schema.Attribute.DefaultTo<'lounge'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    relatedTreatments: Schema.Attribute.Relation<
      ...
      'api::treatment.treatment'
    >;
    source: Schema.Attribute.Enumeration<['google', 'other']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiTreatmentTreatment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isStartingPrice: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    > &
      ...
      Schema.Attribute.DefaultTo<'minimally-invasive'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginPageBuilderEditor extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    defaultTemplateId: Schema.Attribute.String &
      Schema.Attribute.Configurable &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::doctors-page.doctors-page': ApiDoctorsPageDoctorsPage;
